...
definition(
    ...
    namespace: "amn0408",
    author: "An Nguyen",
    description: "Enhanced Control a space heater or window air conditioner in conjunction with any temperature sensor(s). It takes the average of temperature of the sensors and allows for different setpoints based on mode. Based on the original Virtual Thermostat and Green Thermostat apps.",
...
def double getTemperatures()
{
	...
	lastTemp = lastTemp / sensors.size();
    return lastTemp
}
